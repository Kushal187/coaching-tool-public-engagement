...
| 3 | Coaching Loop | `/coach` | User works through 9 Nesta questions one at a time. Each question resolves after 1-4 exchanges. Suggestions appear after each resolution. |
